...
const projects = [
  {
    ...
    link: {
      text: 'Download →',
      url: 'https://licenses.aimarkets.ai/',
    },
  },
  {
...
<section id="projects" class="mx-auto w-full px-6 py-20 md:px-12 lg:px-16 xl:px-20">
  <div class="mb-12 flex flex-col items-end justify-between gap-4 md:flex-row">
    <div>
      <h2 class="text-heading mb-2 text-3xl font-bold">Featured Work</h2>
